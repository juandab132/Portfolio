...
const SkillIcon: React.FC<{ name: string; icon: React.ReactNode }> = ({ name, icon }) => {
  return (
    <section className="flex flex-col items-center gap-4">
      <main className="w-20 h-20 flex items-center justify-center text-[#446B76] transition-transform hover:scale-110 dark:text-white">
      ...
      <span className="text-sm font-medium uppercase text-black dark:text-white">{name}</span>
    </section>
  );
};
    ...
    <section className="bg-[#e8f4f2] py-16 relative text-black dark:bg-[#1F2A33] dark:text-white">
      ...
      <section id="skills" className="max-w-6xl mx-auto px-6 relative z-10 ">
        <section className="max-w-4xl mx-auto">
          ...
          <p className="mb-12 text-black text-center font-serif text-lg dark:text-white">
          ...
          <main className="max-w-2xl mx-auto text-center">
            <h3 className="font-serif font-bold mb-4 dark:text-white">Actualmente estoy trabajando en:</h3>
            <p className="text-sm font-serif leading-relaxed dark:text-white">
