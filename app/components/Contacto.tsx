...
const Contacto = () => {
  return (
    <section id="contact" className="bg-[#6A9CA6] py-16 relative text-white dark:bg-[#1F2A33] dark:text-white">
      <main className="max-w-6xl mx-auto px-6">
        <article className="max-w-4xl mx-auto grid md:grid-cols-2 gap-12">

          <section className="contact-form">
            <h2 className="text-3xl font-serif text-black mb-8 dark:text-white">CONTACTO</h2>
            <form className="space-y-6">
              <fieldset>
                <input
                  type="text"
                  placeholder="Nombre*"
                  className="w-full p-3 rounded bg-white text-black dark:text-white"
                  required
                />
              </fieldset>
              <fieldset>
